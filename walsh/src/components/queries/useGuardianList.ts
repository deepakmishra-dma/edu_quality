...
export const guardin_email_update = () => {
  ...
  const mutationFunction = useCallback(
    (variables: GuardianEmailvariables) => {
      return mutate({
...
export const guardin_number_update = () => {
  ...
  const mutationFunction = useCallback(
    (variables: GuardianNumbervariables) => {
      return mutate({
        url: `/api/resource/Guardian/${variables.name}`,
        method: "put",
        values: variables,
...
export const guardin_father_number_update = ({
  ...
  const mutationFunction = useCallback(
    (variables: GuardianFatherNumbervariables) => {
      return mutate({
        url: `/api/resource/Guardian/${variables.name}`,
        method: "put",
        values: variables,
...
export const updateBloodGroup = () => {
  ...
  const mutationFunction = useCallback(
    (variables: UpdateBloodGroupProps) => {
      return mutate({
        url: `/api/resource/Student/${variables.name}`,
        method: "put",
        values: variables,
...
export const updateAnnualIncome = () => {
  ...
  const mutationFunction = useCallback(
    (variables: UpdateAnnualIncomeProps) => {
      return mutate({
        url: `/api/resource/Guardian/${variables.name}`,
        method: "put",
        values: variables,
