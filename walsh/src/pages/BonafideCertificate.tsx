...
export const BonafideCertificate = () => {
  ...
  const bonafide_name_id = bonafideList?.data?.message?.find(
    (i) => i.student_name === selectedStudent
  )?.student_name;
  ...
  const rows1 = bonafideList?.data?.message?.filter(
    (i) => i.student_name == selectedStudent
  );
        ...
        <tr>
          <td>
            ...
            <Text
              ...
              style={{ width: "152px", margin: "0px auto" }}
            >
              {formattedStartDate}
            </Text>
          </td>
