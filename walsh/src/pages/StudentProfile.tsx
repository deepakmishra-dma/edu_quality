...
export const StudentProfle = () => {
    ...
    // const [editIcom, setEditIcon] = useState(false);
            ...
            <Box>
                <Stack sx={{
                    ...
                    {students.map((student, index) => {
                        ...
                        >
                            <div
                                style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.5rem", background: student.first_name === searchedStudent ? studentProfileColor : "" }}
                                onClick={() => {
                            ...
                            >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler ${student.name === selectedStudent && opened ? "icon-tabler-chevron-up" : "icon-tabler-chevron-up"} `} width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d={`${student.name === selectedStudent && !opened ? "M6 15l6 -6l6 6" : "M6 9l6 6l6 -6"}`} />
                                </svg>
                            ...
                            }} />
                            {
                                ...
                                <StudentProfleFOrm student={student} selectedStudent={selectedStudent} studentProfileColor={studentProfileColor} classDetails={classDetails} isSelected={isSelected} />
                            }
                        </Box>
