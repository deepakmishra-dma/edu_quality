...
def update_stud_data(**data):
    ...
    existing_student_doc.student_is_existingstudent = int(data.get('student_isexistingstudent') or 0)
    existing_student_doc.student_existing_ref_number = data.get('student_existing_ref_number')  
    existing_student_doc.is_sibling_in_school = int(data.get('student_bro_sis_inschool') or 0)
