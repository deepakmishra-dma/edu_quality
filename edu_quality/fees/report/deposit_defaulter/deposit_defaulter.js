...
frappe.query_reports["Deposit Defaulter"] = {
  filters: [
    {
      fieldname: "from_date",
      label: __("From Date"),
    ...
    report.page.add_inner_button(__("Payment Reminder"), function () {
      ...
      frappe.confirm(
        ...
        () => {
          frappe.call({
            method:
              "edu_quality.fees.report.fees_defaulter_report.fees_defaulter_report.send_payment_reminder",
            type: "POST",
            args: {
              data: selected_rows,
            },
    ...
    report.page.add_inner_button(__("Mark As Defaulter"), function () {
      ...
      frappe.confirm(
        ...
        () => {
          frappe.call({
            method:
              "edu_quality.fees.report.fees_defaulter_report.fees_defaulter_report.mark_as_defaulter",
            type: "POST",
            args: {
              data: selected_rows,
            },
