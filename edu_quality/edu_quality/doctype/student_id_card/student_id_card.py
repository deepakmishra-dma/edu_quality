...
class StudentIDCard(Document):
	def autoname(self):
		student = frappe.get_value("Program Enrollment", self.program_enrolled_in, "student")
		academic_year = frappe.get_value("Program Enrollment", self.program_enrolled_in, "academic_year")
	...
	def photo_taken(self):
		return frappe.db.get_value("Program Enrollment", self.program_enrolled_in, "image")
