...
function exportParticipantData(event_detail) {
    frappe.call({
        method: 'edu_quality.edu_quality.doctype.event_participant.event_participant.export_participant_data',
        args: {
...
function convertJSONToCSV(jsonData) {
    ...
    jsonData.map((data) => {
        ...
        // Add the data
        const values = keys.map(key => JSON.stringify(data[key], (key, value) => value === null ? '' : value));
