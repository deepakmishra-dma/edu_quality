        ...
        for student_data in students:
            ...
            if fees_record:
                ...
                for fee_data in fees_record:
                    fees_info.append(f"\n\nFee Schedule: {fee_data.get('fee_schedule')},\n\nFee Structure: {fee_data.get('fee_structure')},\n\nPayment Plan: {fee_data.get('payment_plan')}")
                    ...
                    payment_schedule_info.append(f"\nCustom Payment Schedule for {student_data.get('first_name')}:\n{formatted_payment_schedule}")
            ...
            if payment_entries:
                ...
                for entry in payment_entries:
                    ...
                    payment_entry_info.append(f"\nPayment Entry ID: {entry.get('name')}, URL: {payment_entry_url}")
